...
TEST_F(FigureTest, ThreeDefaultConstructor) {
    Three<double> three;
    EXPECT_NO_THROW(three.Area());
    EXPECT_NO_THROW(three.Centr());
}


TEST_F(FigureTest, ThreeCenterCalculation) {
    Three<double> three;
    Point<double> center = three.Centr();
...
TEST_F(FigureTest, FigureEquality) {
    Three<double> three1({Point<double>(0,0), Point<double>(1,0), 
                       Point<double>(1,1), Point<double>(0,1), Point<double>(0.5,1.5)});
    Three<double> three2({Point<double>(0,0), Point<double>(1,0), 
                       Point<double>(1,1), Point<double>(0,1), Point<double>(0.5,1.5)});
...
TEST_F(FigureTest, FigureInequality) {
    Three<double> three1({Point<double>(0,0), Point<double>(1,0), 
                       Point<double>(1,1), Point<double>(0,1), Point<double>(0.5,1.5)});
    Three<double> three2({Point<double>(0,0), Point<double>(2,0), 
